...
/datum/component/factory/Destroy()
	ducts = null
	reagents = null
	return ..()

/datum/component/factory/process()
...
/datum/component/factory/proc/can_add(datum/ductnet/D, dir)
	if(!active)
		return
	if(!dir || !D)
		return FALSE
...
/datum/component/factory/proc/send_request(dir)
	process_request(amount = MACHINE_MATERIAL_TRANSFER, reagent = null, dir = dir)

///check who can give us what we want, and how many each of them will give us
/datum/component/factory/proc/process_request(amount, reagent, dir)
...
/datum/component/factory/proc/transfer_to(datum/component/factory/target, amount, reagent, datum/ductnet/net)
...
/datum/component/factory/proc/create_overlays(atom/movable/AM, list/overlays)
	SIGNAL_HANDLER
	...
	for(var/D in GLOB.cardinals)
		...
		if(turn_connects)
			I = image('icons/obj/factory/factory.dmi', "[direction]-[color]", layer = AM.layer - 1)

		else
			I = image('icons/obj/factory/factory.dmi', "[direction]-[color]-s", layer = AM.layer - 1) //color is not color as in the var, it's just the name of the icon_state
			I.dir = D
...
/datum/component/factory/proc/disable()
	SIGNAL_HANDLER
...
/datum/component/factory/proc/enable()
	if(active)
		return
		...
		if(D & (demand_connects | supply_connects))
			for(var/atom/movable/A in get_step(parent, D))
				...
				if(istype(A, /obj/machinery/duct))
					...
					var/datum/component/factory/P = A.GetComponent(/datum/component/factory)
					if(P && P.ducting_layer == ducting_layer)
						direct_connect(P, D)

/// Toggle our machinery on or off. This is called by a hook from default_unfasten_wrench with anchored as only param, so we dont have to copypaste this on every object that can move
/datum/component/factory/proc/toggle_active(obj/O, new_state)
	SIGNAL_HANDLER
...
*/
/datum/component/factory/proc/update_dir()
	if(!turn_connects)
		return
...
/datum/component/factory/proc/get_original_direction(dir)
	var/atom/movable/AM = parent
	return turn(dir, dir2angle(AM.dir) - 180)

//special case in-case we want to connect directly with another machine without a duct
/datum/component/factory/proc/direct_connect(datum/component/factory/P, dir)
	if(!P.active)
		return
...
/datum/component/factory/proc/hide(atom/movable/AM, intact)
	SIGNAL_HANDLER

	tile_covered = intact
	AM.update_icon()

/datum/component/factory/proc/change_ducting_layer(obj/caller, obj/O, new_layer = DUCT_LAYER_DEFAULT)
